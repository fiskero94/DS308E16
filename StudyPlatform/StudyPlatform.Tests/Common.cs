...
namespace StudyPlatform.Tests
{
    static class Common
    {
        ...
        public static void TestActionForExceptionThrown<T1>
            (Exception exception, Action<T1> action, T1 P1)
        {
            // Act & Assert
            try
            {
        ...
        public static void TestActionForExceptionThrown<T1, T2>
            (Exception exception, Action<T1, T2> action, T1 P1, T2 P2)
        {
            // Act & Assert
            try
            {
        ...
        public static void TestActionForExceptionThrown<T1, T2, T3>
            (Exception exception, Action<T1, T2, T3> action, T1 P1, T2 P2, T3 P3)
        {
            // Act & Assert
            try
            {
        ...
        public static void TestActionForExceptionThrown<T1, T2, T3, T4>
            (Exception exception, Action<T1, T2, T3, T4> action, T1 P1, T2 P2, T3 P3, T4 P4)
        {
            // Act & Assert
            try
            {
        ...
        public static void TestActionForExceptionThrown<T1, T2, T3, T4, T5>
            (Exception exception, Action<T1, T2, T3, T4, T5> action, T1 P1, T2 P2, T3 P3, T4 P4, T5 P5)
        {
            // Act & Assert
            try
            {
        ...
        public static void TestActionForExceptionThrown<T1, T2, T3, T4, T5, T6, T7>
            (Exception exception, Action<T1, T2, T3, T4, T5, T6, T7> action, T1 P1, T2 P2, T3 P3, T4 P4, T5 P5, T6 P6, T7 P7)
        {
            // Act & Assert
            try
            {
        ...
        public static void TestActionForExceptionThrown<T1, T2, T3, T4, T5, T6>
            (Exception exception, Action<T1, T2, T3, T4, T5, T6> action, T1 P1, T2 P2, T3 P3, T4 P4, T5 P5, T6 P6)
        {
            // Act & Assert
            try
            {
